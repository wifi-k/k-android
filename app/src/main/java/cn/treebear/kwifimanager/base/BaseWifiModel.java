...
import cn.treebear.kwifimanager.http.HttpObserver;
import cn.treebear.kwifimanager.http.WiFiApi;
...
public class BaseWifiModel implements IModel {
    /**
     * API service对象
     */
    protected WiFiApi mService = WiFiHttpClient.getInstance().getApiService();
    /**
     * 请求队列
     */
