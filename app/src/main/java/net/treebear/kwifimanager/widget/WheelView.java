...
public class WheelView extends ScrollView {
    ...
    private int colorNormal = Color.parseColor("#4A5A78");
    private int colorSelected = Color.parseColor("#28DEB8");
    private int colorBackground = Color.parseColor("#83cde6");
    private int colorNormalBackground = Color.parseColor("#D8D8D8");
    private int colorSelectedBackground = Color.WHITE;
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(colorSelected);
                itemView.setBackgroundColor(colorSelectedBackground);
            } else {
                itemView.setTextColor(colorNormal);
                itemView.setBackgroundColor(colorNormalBackground);
            }
        }
    }
